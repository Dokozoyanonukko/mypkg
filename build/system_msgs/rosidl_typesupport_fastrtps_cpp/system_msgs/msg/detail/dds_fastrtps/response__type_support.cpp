...
#include "system_msgs/msg/detail/response__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = system_msgs::msg::Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const system_msgs::msg::Response *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<system_msgs::msg::Response *>(
    untyped_ros_message);
...
{
  return &system_msgs::msg::typesupport_fastrtps_cpp::_Response__handle;
}
