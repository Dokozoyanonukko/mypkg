...
#include "system_msgs/msg/detail/response__rosidl_typesupport_fastrtps_c.h"
...
using _Response__ros_msg_type = system_msgs__msg__Response;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = system_msgs__msg__Response;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const system_msgs__msg__Response * ros_message = static_cast<const system_msgs__msg__Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_system_msgs__msg__Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  system_msgs__msg__Response * ros_message = static_cast<system_msgs__msg__Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_system_msgs__msg__Response(cdr, ros_message);
}

static uint32_t _Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_system_msgs__msg__Response(
...
static size_t _Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_system_msgs__msg__Response(
