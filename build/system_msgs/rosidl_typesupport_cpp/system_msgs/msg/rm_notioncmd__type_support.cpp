...
static const _RmNotioncmd_type_support_symbol_names_t _RmNotioncmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, system_msgs, msg, RmNotioncmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, system_msgs, msg, RmNotioncmd)),
  }
};
...
{
  return &::system_msgs::msg::rosidl_typesupport_cpp::RmNotioncmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, system_msgs, msg, RmNotioncmd)() {
  return get_message_type_support_handle<system_msgs::msg::RmNotioncmd>();
}
