...
system_msgs__msg__RmNotioncmd__create(void)
{
  ...
  system_msgs__msg__RmNotioncmd * msg = (system_msgs__msg__RmNotioncmd *)allocator.allocate(sizeof(system_msgs__msg__RmNotioncmd), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(system_msgs__msg__RmNotioncmd));
  bool success = system_msgs__msg__RmNotioncmd__init(msg);
  if (!success) {
...
system_msgs__msg__RmNotioncmd__destroy(system_msgs__msg__RmNotioncmd * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    system_msgs__msg__RmNotioncmd__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
system_msgs__msg__RmNotioncmd__Sequence__init(system_msgs__msg__RmNotioncmd__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  system_msgs__msg__RmNotioncmd * data = NULL;

  if (size) {
    data = (system_msgs__msg__RmNotioncmd *)allocator.zero_allocate(size, sizeof(system_msgs__msg__RmNotioncmd), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = system_msgs__msg__RmNotioncmd__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        system_msgs__msg__RmNotioncmd__fini(&data[i - 1]);
      }
...
system_msgs__msg__RmNotioncmd__Sequence__fini(system_msgs__msg__RmNotioncmd__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      system_msgs__msg__RmNotioncmd__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  system_msgs__msg__RmNotioncmd__Sequence * array = (system_msgs__msg__RmNotioncmd__Sequence *)allocator.allocate(sizeof(system_msgs__msg__RmNotioncmd__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = system_msgs__msg__RmNotioncmd__Sequence__init(array, size);
  if (!success) {
...
system_msgs__msg__RmNotioncmd__Sequence__destroy(system_msgs__msg__RmNotioncmd__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    system_msgs__msg__RmNotioncmd__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
system_msgs__msg__RmNotioncmd__Sequence__are_equal(const system_msgs__msg__RmNotioncmd__Sequence * lhs, const system_msgs__msg__RmNotioncmd__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!system_msgs__msg__RmNotioncmd__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  system_msgs__msg__RmNotioncmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(system_msgs__msg__RmNotioncmd);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    system_msgs__msg__RmNotioncmd * data =
      (system_msgs__msg__RmNotioncmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!system_msgs__msg__RmNotioncmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          system_msgs__msg__RmNotioncmd__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!system_msgs__msg__RmNotioncmd__copy(
